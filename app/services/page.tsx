            ...
            <div>
              ...
              <div className="space-y-4 text-sm-light leading-relaxed">
                ...
                <div className="flex items-center gap-4 mt-6">
                  <a href="https://www.linkedin.com/in/miles-cass-0a01973b7/" target="_blank" rel="noopener noreferrer" className="text-sm text-sm-muted hover:text-white transition-colors">LinkedIn</a>
