      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white text-sm font-semibold rounded-sm hover:shadow-[0_0_20px_rgba(249,115,22,0.3)] transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
          >
            Get a Quote
          </button>
        </nav>
        ...
        >
          <nav className="flex flex-col items-center gap-8 pt-16">
            ...
            <button
              ...
              className="px-8 py-3 bg-white text-black font-semibold rounded-sm"
            >
              Get a Quote
            </button>
          </nav>
